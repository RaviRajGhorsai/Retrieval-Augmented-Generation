...
import argparse
from lib.keyword_search import search_command, build_command, tf_command, idf_command, tf_idf_command, bm_idf_command 
...
def main() -> None:
    ...
    build_parser = subparsers.add_parser("build", help="build cache and save for BM25 search")
